(function() {
	...
	$locationProvider.html5Mode(true);
	    ...
	    .when('/ui/phoneServices/serviceConfiguration', {
		templateUrl: 'phoneServices/serviceConfiguration/all/serviceConfiguration.view.html',
		controller: "serviceConfigurationCtrl",
		controllerAs: 'vm'
	    })
